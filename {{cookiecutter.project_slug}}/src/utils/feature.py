...
class BaseFeature:
    """Feature Base Class.
    This class is used to create and cache features.
    ...
    Examples:
        class CustomFeature(BaseFeature):
            ...
            @BaseFeature.cache()
            def create_feature_1(self) -> np.ndarray:
                return np.random.rand(100, 10)

            @BaseFeature.cache()
            def create_feature_2(self) -> np.ndarray:
                return np.random.rand(100, 10)

        feature = CustomFeature(data)
